...
it 'should return a 200 reponse' do
  expect(response).to have_http_status 200
end

it 'should return a list of menu items' do 
  expect(reponse_json["products"].length).to eq 3
end

it 'should return items with a name' do
  expect(reponse_json["products"][0]).to have_key('name')
end

it 'should return items with a price' do
  expect(reponse_json)["products"][0]).to have_key('price')
end
